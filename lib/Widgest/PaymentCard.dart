...
//   final int? daysRemaining; // Null if paid or no due date
...
//     // Update display status based on daysRemaining
//     if (daysRemaining != null) {
//       if (daysRemaining! > 0) {
//         displayStatus = "Due in ${daysRemaining!} Days";
//       } else if (daysRemaining! < 0) {
//         displayStatus = "Overdue ${daysRemaining!.abs()} Days";
//       }
//     }
...
//                     ),
//                     child: Text(
//                       tenantStatus, // Dynamic tenant status
//                       style: const TextStyle(
//                         fontSize: 6,
//                         fontWeight: FontWeight.w700,
//                         color: Color(0xFF252B5C),
