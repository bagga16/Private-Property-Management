...
//                     children: [
//                       Text(
//                         "ID: ${property.id.substring(property.id.length - 6)}", // Last 6 digits
//                         style: const TextStyle(
//                           fontSize: 9,
...
//                                   color: Color.fromRGBO(83, 88, 122, 1),
//                                 ),
//                                 maxLines: 2, // Wraps text into multiple lines
//                                 overflow: TextOverflow.ellipsis,
//                               ),
//                             ),
//                           ],
...
//                             ),
//                             TextSpan(
//                               text: formatDate(property
//                                   .createdDate), // Formatted created date
//                               style: const TextStyle(
//                                 fontSize: 9,
//                                 fontWeight: FontWeight.w400,
//                                 color: Color.fromRGBO(83, 88, 122, 1),
...
//                             TextSpan(
//                               text: formatDate(property
//                                   .updatedDate), // Formatted updated date
//                               style: const TextStyle(
//                                 fontSize: 9,
//                                 fontWeight: FontWeight.w400,
//                                 color: Color.fromRGBO(83, 88, 122, 1),
